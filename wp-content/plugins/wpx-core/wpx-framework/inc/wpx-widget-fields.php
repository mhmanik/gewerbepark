...
if( !class_exists( 'WpX_Widget_Fields' ) ){

	class WpX_Widget_Fields {
		...
		public static function display( $fields, $instance, $object ){
			foreach ( $fields as $key => $field ) {
				...
				if ( method_exists( __CLASS__, $field['type'] ) ) {
					echo '<div class="wpx-widget-field">';
		...
		public static function image( $id, $name, $value, $label, $options ){
			...
			<input class="wpx_upload_image upload_button_'. esc_attr( $id ) .' button-primary" type="button" value="' . esc_attr__( 'Choose Image', 'wpx' ). '" />
